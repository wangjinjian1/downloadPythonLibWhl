...
def downloadLib(nes,flag = False,useproxy = False,installed = False,installpiptree = True,packagePath = 'packages',proxy_='--trusted-host https://repo.huaweicloud.com -i https://repo.huaweicloud.com/repository/pypi/simple'):
    '''
...
if __name__=='__main__':
    ...
    nes = {'matplotlib', 'requests', 'pandas', 'xlrd', 'xlwt', 'openpyxl', 'numpy',
           'scikit-learn', 'Pillow', 'lxml', 'snowland-smx', 'selenium', 'aiohttp',
           'httpx', 'SQLAlchemy', 'setuptools', 'pip','pyautogui','pyqt5','opencv-python',
           'pyyaml','pycryptodome','pyinstaller'}
    downloadLib(nes,flag=True,installed=True,installpiptree=False)